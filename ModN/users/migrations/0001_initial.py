    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('MAIN', 'MAIN'), ('SUB', 'SUB')], max_length=10)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='user',
            name='address',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.CustomerAddress'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
